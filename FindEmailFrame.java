...
public class FindEmailFrame extends Frame implements Runnable, EmailReceiver
{
    ...
    private Button startstop, reset, quit;
    private List limail;
    ...
    {
	FindEmailFrame fef = new FindEmailFrame("Email Finder");
	fef.setResizable(false);
	fef.setSize(810, 380);
	fef.show();
    }

    public FindEmailFrame(String title)
    {
	super(title);
	...
	Rectangle r = new Rectangle(0, 25, 20, 18);
	lurl.setBounds(r);
	r.setBounds(0, 43, 400, 95);
	taurl.setBounds(r);
	r.setBounds(0, 143, 150, 18);
	lmailkeywords.setBounds(r);
	r.setBounds(0, 161, 200, 100);
	tamailkeywords.setBounds(r);
	r.setBounds(200, 143, 150, 18);
	ltextkeywords.setBounds(r);
	r.setBounds(200, 161, 200, 100);
	tatextkeywords.setBounds(r);
	r.setBounds(25, 266, 225, 18);
	stoponemailfound.setBounds(r);
	r.setBounds(25, 288, 275, 18);
	ltdepth.setBounds(r);
	r.setBounds(300, 283, 60, 25);
	tftdepth.setBounds(r);
	r.setBounds(25, 323, 70, 23);
	reset.setBounds(r);
	r.setBounds(110, 323, 70, 23);
	quit.setBounds(r);
	r.setBounds(195, 323, 70, 23);
	startstop.setBounds(r);
	r.setBounds(0, 356, 400, 18);
	info.setBounds(r);
	r.setBounds(400, 25, 100, 18);
	lmail.setBounds(r);
	r.setBounds(400, 43, 400, 95);
	limail.setBounds(r);
	r.setBounds(400, 143, 150, 17);
	lhl.setBounds(r);
	r.setBounds(400, 160, 400, 215);
	tahl.setBounds(r);
    }
	...
	if(e.target == startstop) {
		...
		try {
		    ...
		    traversal_depth = 3;
		    tahl.append("**** Error reading Search Depth.  Searching default 3 levels deep...\n");
		    tahl.append("********************\n");
		}
